...
class Retinaface(object):
    ...
    def get_defaults(cls, name):
        if name in cls._defaults:
            ...
            return "Unrecognized attribute name '" + name + "'"
    ...
    def detect_image(self, image):
        ...
        #---------------------------------------------------#
        scale = [np.shape(image)[1], np.shape(image)[0]] * 2
        scale_for_landmarks = [np.shape(image)[1], np.shape(image)[0]] * 5
        ...
        for b in boxes_conf_landms:
            ...
            print('人脸框位置: x1={}, y1={}, x2={}, y2={}, confidence={:.4f}'.format(b[0], b[1], b[2], b[3], confidence))
            # b[5]-b[14]为人脸关键点的坐标
